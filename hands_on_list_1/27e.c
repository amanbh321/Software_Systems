...
#include <unistd.h>  // Required for the `execvp` function
#include <stdio.h>   // Required for the `printf` function

int main()
{
    // Define the command and its arguments
    char *commandArgs[] = {"ls", "-Rl", ".", NULL};  // Specify the directory and options for `ls` command

    // Display output header
    printf("============ OUTPUT USING execvp =============\n");

    // Execute the `ls` command with the specified arguments
...
/*
============================================================================
aman@aman-HP-Laptop-15s-gr0xxx:~/Desktop/hands_on_list_1$ gcc 27e.c
...
-rw-rw-r-- 1 aman aman  3733 Aug 31 22:09 27c.c
-rw-rw-r-- 1 aman aman  3650 Aug 31 22:11 27d.c
-rw-rw-r-- 1 aman aman  1784 Aug 31 22:12 27e.c
...
-rwxrwxr-x 1 aman aman 16056 Aug 31 22:12 a.out
