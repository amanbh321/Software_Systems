...
int main()
{
    ...
    // Display a header before running the command
    printf("============ OUTPUT USING execl =============\n");

    // Execute the `ls` command with the specified options and target directory
    execl(cmd_path, cmd_path, cmd_options, target_dir, NULL);

    // This line will only be executed if execl fails
...
/*
============================================================================
aman@aman-HP-Laptop-15s-gr0xxx:~/Desktop/hands_on_list_1$ gcc 27a.c 
...
-rw-rw-r-- 1 aman aman  1871 Aug 31 21:59 27a.c
-rw-rw-r-- 1 aman aman  1841 Aug 31 21:52 27b.c
...
-rwxrwxr-x 1 aman aman 16000 Aug 31 21:59 a.out
