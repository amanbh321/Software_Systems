...
#include <unistd.h>  // Required for the `execv` function
#include <stdio.h>   // Required for the `printf` function

int main()
{
    // Define the command and its arguments
    char *arguments[] = {"/bin/ls", "-Rl", ".", NULL};  // Directory and options for the `ls` command
...
/*
============================================================================
aman@aman-HP-Laptop-15s-gr0xxx:~/Desktop/hands_on_list_1$ gcc 27d.c
...
-rw-rw-r-- 1 aman aman  1766 Aug 31 22:09 27d.c
...
-rwxrwxr-x 1 aman aman 16048 Aug 31 22:10 a.out
